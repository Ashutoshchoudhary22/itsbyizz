...
import { FaPenNib, FaBlog, FaVideo, FaFileAlt, FaChartLine } from 'react-icons/fa';

const ContentMarketing = () => {
    const contentServices = [
        {
          title: "Creative Content Creation",
          description: "We craft engaging content, from articles to infographics, to inform and inspire.",
          icon: <FaPenNib className="w-10 h-10 text-green-500"/>,
        },
        {
          title: "Blog Management",
          description: "We optimize and manage blogs to enhance SEO and establish industry authority.",
          icon: <FaBlog className="w-10 h-10 text-green-500"/>,
        },
        {
          title: "Social Media Content",
          description: "We create shareable content that drives engagement and brand advocacy.",
          icon: <FaFileAlt className="w-10 h-10 text-green-500"/>,
        },
        {
          title: "Video Content",
          description: "We produce compelling videos to tell your brand's story effectively.",
          icon: <FaVideo className="w-10 h-10 text-green-500"/>,
        },
        {
          title: "SEO Content Optimization",
          description: "We enhance content with SEO techniques to boost visibility and traffic.",
