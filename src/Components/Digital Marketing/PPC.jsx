...
import { FaSearchDollar, FaCog, FaFlask, FaRocket, FaRedo } from 'react-icons/fa';

const PPC = () => {
    const ppcServices = [
        {
          title: "Keyword Research",
          description: "We find high-converting keywords to maximize ad performance and ROI.",
          icon: <FaSearchDollar className="w-10 h-10 text-green-500" />,
        },
        {
          title: "Campaign Management",
          description: "We set up, manage, and optimize PPC campaigns for peak efficiency.",
          icon: <FaCog className="w-10 h-10 text-green-500" />,
        },
        {
          title: "A/B Testing",
          description: "We test ad variations to identify the most effective strategies.",
          icon: <FaFlask className="w-10 h-10 text-green-500" />,
        },
        {
          title: "Landing Page Optimization",
          description: "We refine landing pages to enhance user experience and boost conversions.",
          icon: <FaRocket className="w-10 h-10 text-green-500" />,
        },
        {
          title: "Remarketing & Retargeting",
          description: "We re-engage potential customers to improve conversion rates.",
