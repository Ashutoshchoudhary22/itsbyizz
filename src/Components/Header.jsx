  ...
  return (
    <nav className="flex px-4 md:shadow-lg items-center relative">
      ...
      <ul className="md:px-2 ml-auto md:flex md:space-x-2 absolute md:relative top-full left-0 right-0">
        <li>
          <NavLink to="/" className=" text-gray-50 flex md:inline-flex p-4 items-center hover:text-white">
            <span>Home</span>
          </NavLink>
        </li>
        <li>
          <a href="#" className=" text-gray-50 flex md:inline-flex p-4 items-center hover:text-white">
            <span>Products</span>
          </a>
        </li>
        <li className="relative group">
          <a href="#" className="text-gray-50 flex justify-between p-4 items-center hover:text-white space-x-2">
          ...
          <ul className="hidden group-hover:flex transition duration-300 md:absolute top-full left-0 md:w-auto bg-white md:shadow-lg md:rounded-b-lg p-2 flex-wrap">
            {developmentmenu.map((item, index) => (
              <li key={index} className="p-2 hover:bg-gray-100 rounded-lg w-48">
                <NavLink to={item.link} className="block text-gray-900 font-normal">
                  {item.title}
                </NavLink>
              </li>
            ))}
        ...
        <li className="relative group">
          <a href="#" className="text-gray-50 flex justify-between md:inline-flex p-4 items-center hover:text-white space-x-2">
        ...
        <li>
          <NavLink to="/portfolio" className="text-gray-50 flex md:inline-flex p-4 items-center hover:text-white">
            <span>Portfolio</span>
          </NavLink>
        </li>
        {/* Sign Up Dropdown */}
        <li className="relative group">
          <a href="#" className="text-gray-50 flex items-center p-4 hover:text-white space-x-2">
