...
const CareerList = () => {
  ...
  const CareerListData = [
    { id: 1, date: '2025-03-10', name: 'Alice Brown', mobile: '1234567890', designation: 'Software Engineer' },
    { id: 2, date: '2025-03-11', name: 'David Miller', mobile: '9876543210', designation: 'Product Manager' },
    { id: 3, date: '2025-03-12', name: 'Emily Wilson', mobile: '5556667777', designation: 'UI/UX Designer' },
  ];

  const filteredCareerList = CareerListData.filter(entry =>
