...
const Contacts = () => {
    ...
    const contactData = [
      { id: 1, date: '2025-03-10', name: 'Michael Scott', mobile: '1234567890', city: 'Scranton' },
      { id: 2, date: '2025-03-11', name: 'Pam Beesly', mobile: '9876543210', city: 'New York' },
      { id: 3, date: '2025-03-12', name: 'Jim Halpert', mobile: '5556667777', city: 'Stamford' },
    ];
  
    const filteredContact = contactData.filter(entry =>
