          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-8 items-center min-h-[400px] md:min-h-[500px]">
            ...
            >
              ...
              <motion.div
                ...
                className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-white/20 to-white/10 backdrop-blur-sm text-white rounded-full text-sm font-medium mb-6 border border-white/20"
              >
