...
const Home = () => {
  ...
  return (
    <div className="w-full relative overflow-hidden">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-[#053d5e] via-[#0a5a7a] to-[#0d6b8a] max-w-screen-2xl mx-2 sm:mx-4 md:mx-6 lg:mx-8 rounded-b-3xl py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32 overflow-hidden">
      ...
      {/* Image Slider */}
      <motion.div 
        className="w-full max-w-screen-xl mx-auto px-2 sm:px-4 md:px-6 -mt-8 sm:-mt-10 relative z-20"
