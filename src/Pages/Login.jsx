  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        {/* Header Section */}
        <motion.div 
          className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 w-full h-72 flex items-center justify-center px-4 relative overflow-hidden"
        ...
        <div className="flex justify-center px-4 -mt-20 mb-10">
          ...
          >
            ...
            <form onSubmit={submitHandler} className="space-y-6">
              ...
              >
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 bg-white/80 backdrop-blur-sm"
                  />
                </div>
              </motion.div>
              ...
              >
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-12 py-4 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 bg-white/80 backdrop-blur-sm"
                  />
                  <button
                    type="button"
              ...
              >
                <NavLink to="/forgot-password" className="text-sm text-blue-600 hover:text-blue-700 transition-colors duration-200">
                  Forgot Password?
                </NavLink>
              </motion.div>
