  ...
  return (
    <div className="min-h-screen bg-gray-100 relative">
        ...
        <div className="col-span-1 flex items-center">
            <div className="w-2/3">
            <h1 className="text-green-500 text-4xl font-bold ">Create Your Account</h1>
            <p className="text-white text-2xl ">Enter your personal details and start the journey with us</p>
            </div>
        </div>
        ...
        <div className="w-full md:w-3/5 p-8 absolute right-10 top-50 bg-white rounded-lg reveal">
          ...
          <form className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-6 p-6 ">
            ...
            <input
              ...
              required
              className="input-style p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <input
              type="text"
